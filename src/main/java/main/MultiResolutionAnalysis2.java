...
import game.plugins.weka.algorithms.WekaMultilayerPerceptron;
...
public class MultiResolutionAnalysis2 {
	...
	private static List<Configuration> prepareConfigurations() {
		...
		int[] profileSizes = { 5, 10, 15, 20, 25 };
		double[] sigmaMaxPercents = { 0.10, 0.15, 0.20, 0.25, 0.30 };
...
//		classifiers[1].setContent("trainingAlgorithm", new WekaMultilayerPerceptron());
		classifiers[0].setContent("trainingAlgorithm", new WekaJ48());
	...
	public static void main(String[] args) throws Exception {
		...
		Output output = new Output(new FileOutputStream("results_j48.dat"));
